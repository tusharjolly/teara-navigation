import svgPaths from "./svg-njapksg2ix";
import imgMap from "figma:asset/948540a80b08b11c7f9fea140c43d5fe43103d7e.png";
import { imgGroup } from "./svg-cq4dy";

function BuildingsList() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[25px] h-[187px] items-center justify-center leading-[1.4] left-[calc(16.67%+12.5px)] not-italic text-[20px] text-black top-[349px] w-[174px]" data-name="buildings list">
      <p className="relative shrink-0 w-full">G Block</p>
      <p className="relative shrink-0 w-full">L Block</p>
      <p className="relative shrink-0 w-full">The Pā</p>
      <p className="relative shrink-0 w-full">Student Centre</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[11.336px] right-[27.34px] top-[17.33px] w-[66.661px]" data-name="Right Side">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67 12">
        <g id="Right Side">
          <g id="Battery">
            <path d={svgPaths.p18c81cf0} fill="var(--fill-0, black)" id="Rectangle" opacity="0.35" stroke="var(--stroke-0, black)" />
...
function Time() {
  return (
    <div className="absolute h-[21px] left-[24px] rounded-[24px] top-[12px] w-[54px]" data-name="_Time">
      <p className="absolute font-['SF_Pro_Text:Semibold',sans-serif] h-[20px] leading-[20px] left-[27px] not-italic text-[15px] text-black text-center top-px tracking-[-0.5px] translate-x-[-50%] w-[54px]">9:41</p>
    </div>
  );
}
...
function StatusBarIPhone1313Pro() {
  return (
    <div className="bg-white h-[44px] overflow-clip pointer-events-auto sticky top-0 w-[393px]" data-name="Status Bar / iPhone 13 & 13 Pro">
      <Notch />
      <RightSide />
      <LeftSide />
    </div>
...
function Close() {
  return (
    <div className="relative shrink-0 size-[29.3px]" data-name="close">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g>
          <path d={svgPaths.p78ae00} fill="var(--fill-0, black)" id="icon" />
        </g>
      </svg>
    </div>
  );
...
function Component() {
  return (
    <div className="h-[29.33px] relative shrink-0 w-[97.38px]" data-name="Component 2">
      <Group />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="dark_mode">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="dark_mode">
          <path d={svgPaths.pf9cdd20} fill="var(--fill-0, black)" id="icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame3() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[146px]">
      <DarkMode />
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[1.4] not-italic relative shrink-0 text-[20px] text-black text-nowrap whitespace-pre">Dark Mode</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[40px]" data-name="switch">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 24">
        <g id="switch">
          <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Rectangle 11" rx="12" width="40" />
          <circle cx="12" cy="12" fill="var(--fill-0, #474242)" id="Ellipse 14" r="10" />
        </g>
      </svg>
    </div>
  );
...
function DarkMode1() {
  return (
    <div className="content-stretch flex gap-[68px] items-end relative shrink-0 w-full" data-name="Dark Mode">
      <Frame3 />
      <Switch />
    </div>
  );
...
function Language() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="language">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="language">
          <path d={svgPaths.p580740} fill="var(--fill-0, black)" id="icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-[127px]" data-name="frame2">
      <Language />
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[1.4] not-italic relative shrink-0 text-[20px] text-black text-nowrap whitespace-pre">Language</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="h-[17px] relative shrink-0 w-[14px]" data-name="frame1">
      <div className="absolute bottom-0 left-[-14.29%] right-0 top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 17">
          <g id="frame1">
            <path d={svgPaths.p1d2b7d00} id="Icon" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
          </g>
        </svg>
      </div>
    </div>
...
function Language1() {
  return (
    <div className="content-stretch flex gap-[96px] items-center overflow-clip relative shrink-0 w-full" data-name="language">
      <Frame4 />
      <Frame5 />
    </div>
  );
...
function Icon() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="icon">
          <path d={svgPaths.p126b5bc0} id="Vector" stroke="var(--stroke-0, black)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function BuildingsList1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Buildings List">
      <Icon />
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[1.4] not-italic relative shrink-0 text-[20px] text-black text-nowrap whitespace-pre">Buildings List</p>
    </div>
  );
}

function ChunkAngleDown() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="chunk/angle-down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="chunk/angle-down">
          <path d={svgPaths.p334b0100} fill="var(--fill-0, black)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="frame1">
      <ChunkAngleDown />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[48px] h-[28px] items-center justify-center relative shrink-0 w-[236px]">
      <BuildingsList1 />
      <Frame6 />
    </div>
  );
...
function Menu() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[47px] items-start left-[21px] top-[146px] w-[254px]" data-name="menu">
      <DarkMode1 />
      <Language1 />
      <Frame7 />
    </div>
...
export default function BuildingsList2() {
  return (
    <div className="bg-white relative size-full" data-name="buildings list">
      ...
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[1.4] left-[calc(50%+51.5px)] not-italic text-[20px] text-black text-nowrap top-[68.67px] whitespace-pre">Campus Map</p>
      <div className="absolute bg-black h-[852px] left-0 opacity-40 top-0 w-[393px]" data-name="overlay" />
      <div className="absolute bg-white h-[852px] left-0 top-[-2px] w-[305px]" data-name="drawerPanel" />
      <BuildingsList />
