...
function ZoomControls() {
  return (
    <div className="absolute bottom-[103px] h-[81px] right-[calc(83.33%+1.5px)] w-[40px]" data-name="Zoom Controls">
...
function ButtonIcon() {
  return (
    <div className="absolute bg-[#1973e8] box-border content-stretch flex gap-[4px] items-center justify-center left-[calc(83.33%-7.5px)] p-[8px] rounded-[100px] shadow-[0px_8px_12px_0px_rgba(0,0,0,0.3)] size-[56px] top-[702px]" data-name="button/icon">
      <Icon />
    </div>
  );
}
...
function IndoorMapButton() {
  return (
    <div className="absolute contents left-[calc(66.67%+5px)] top-[801px]" data-name="indoor map button">
      <div className="absolute flex flex-col font-['SF_Pro:Bold',sans-serif] font-bold h-[13.184px] justify-center leading-[0] left-[calc(83.33%-7.6px)] text-[#007aff] text-[14px] text-center top-[820.78px] translate-x-[-50%] translate-y-[-50%] w-[80.741px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal]">Indoor Map</p>
      </div>
      <div className="absolute h-[38px] left-[calc(66.67%+5px)] top-[801px] w-[109px]">
...
function Group1() {
  return (
    <div className="absolute contents left-px top-[773px]">
      <div className="absolute bg-white h-[79px] left-px rounded-tl-[20px] rounded-tr-[20px] top-[773px] w-[392px]" />
      <div className="absolute flex h-[3px] items-center justify-center left-[calc(33.33%+38px)] top-[781px] w-[56px]">
        <div className="flex-none rotate-[180deg] scale-y-[-100%]">
          <div className="bg-[#cccccc] h-[3px] rounded-[100px] w-[56px]" data-name="Home Indicator" />
        </div>
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[13.761px] leading-[normal] left-[39px] not-italic text-[22px] text-black top-[806px] w-[80px]">G Block</p>
      <IndoorMapButton />
    </div>
  );
}
...
function Close() {
  return (
    <div className="absolute left-[15px] size-[24px] top-[780px]" data-name="close">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g>
...
export default function WhenClickABuilding() {
  return (
    <div className="bg-white relative size-full" data-name="when click a building">
      ...
      <ZoomControls />
      <div className="absolute flex h-[84.713px] items-center justify-center left-[calc(33.33%+16px)] top-[218px] w-[75.623px]" style={{ "--transform-inner-width": "69", "--transform-inner-height": "79" } as React.CSSProperties}>
