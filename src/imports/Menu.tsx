...
function DarkMode1() {
  return (
    <div className="absolute content-stretch flex gap-[68px] items-center justify-center left-[21px] top-[146px]" data-name="Dark Mode">
      <Frame3 />
      <Switch />
    </div>
  );
...
function BuildingsList() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[22px] top-[296px]" data-name="Buildings List">
      <Icon />
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="frame2">
      <Language />
...
function Language1() {
  return (
    <div className="absolute box-border content-stretch flex gap-[86px] items-center left-[9px] px-[13px] py-0 top-[221px] w-[296px]" data-name="language">
      <Frame4 />
      <Frame5 />
    </div>
  );
...
function Menu() {
  return (
    <div className="absolute contents left-[9px] top-[146px]" data-name="menu">
      <DarkMode1 />
      <BuildingsList />
      <Language1 />
    </div>
...
function Frame6() {
  return (
    <div className="absolute h-[17px] left-[calc(50%+46.5px)] top-[301px] w-[14px]" data-name="frame1">
      <div className="absolute bottom-0 left-[-14.29%] right-0 top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 17">
          <g id="frame1">
            <path d={svgPaths.p1d2b7d00} id="Icon" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
