import svgPaths from "./svg-thjg8xekjb";
import imgImage24112025At09591 from "figma:asset/46c55aef4864e0dd5a25689ecf3745917d8c6dcb.png";
import { imgGroup } from "./svg-9jl02";
...
function ZoomControls() {
  return (
    <div className="absolute bottom-[44px] h-[81px] right-[calc(83.33%+16.5px)] w-[40px]" data-name="Zoom Controls">
...
function Group1() {
  return (
    <div className="absolute h-[16px] left-[16px] top-[128px] w-[16.5px]">
...
function Group2() {
  return (
    <div className="absolute contents left-0 top-[121px]">
      <div className="absolute h-[65.5px] left-0 top-[121px] w-[393px]" data-name="Rectangle">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Rectangle"></g>
        </svg>
      </div>
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[23px] justify-center leading-[0] left-[calc(50%-41.5px)] not-italic text-[16px] text-black top-[155.5px] translate-y-[-50%] w-[83px]">
        <p className="leading-[24px]">G Block</p>
      </div>
    </div>
  );
}
...
function L2() {
  return (
    <div className="absolute contents left-[calc(66.67%-10.9px)] top-[204.1px]" data-name="l3">
      <div className="absolute bg-[#f2f6fc] h-[32.903px] left-[calc(66.67%-10.9px)] rounded-[10px] top-[204.1px] w-[56.903px]" />
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[16.452px] justify-center leading-[0] left-[calc(75%-21.93px)] not-italic text-[#5e5e5e] text-[10px] top-[220px] translate-y-[-50%] w-[14.484px]">
        <p className="leading-[24px]">L3</p>
      </div>
    </div>
  );
}
...
function L1() {
  return (
    <div className="absolute contents left-[calc(50%-4.38px)] top-[204.1px]" data-name="L2">
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[16.452px] justify-center leading-[0] left-[calc(50%-4.38px)] not-italic text-[#5e5e5e] text-[10px] top-[220px] translate-y-[-50%] w-[14.484px]">
        <p className="leading-[24px]">L2</p>
      </div>
      <div className="absolute h-[32.903px] left-[calc(66.67%-10.9px)] opacity-[0.55] rounded-[10px] top-[204.1px] w-[56.903px]" />
    </div>
  );
}
...
function L() {
  return (
    <div className="absolute contents left-[calc(16.67%+24.2px)] top-[203px]" data-name="L1">
      <div className="absolute bg-[#f2f6fc] h-[32.903px] left-[calc(16.67%+24.2px)] rounded-[10px] top-[203px] w-[56.903px]" />
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[16.452px] justify-center leading-[0] left-[calc(25%+13.18px)] not-italic text-[#5e5e5e] text-[10px] top-[220px] translate-y-[-50%] w-[14.484px]">
        <p className="leading-[24px]">L1</p>
      </div>
    </div>
  );
}
...
function Ground() {
  return (
    <div className="absolute contents left-[9px] top-[203px]" data-name="ground">
      <div className="absolute bg-[#1973e8] h-[32.903px] left-[9px] rounded-[10px] top-[203px] w-[56.903px]" />
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[16.452px] justify-center leading-[0] left-[calc(8.33%-15.47px)] not-italic text-[10px] text-white top-[220px] translate-y-[-50%] w-[41.384px]">
        <p className="leading-[24px]">Ground</p>
      </div>
    </div>
  );
}
...
function Floor() {
  return (
    <div className="absolute contents left-[9px] top-[203px]" data-name="floor">
      <L2 />
      <div className="absolute bg-[#f2f6fc] h-[32.903px] left-[calc(33.33%+39.4px)] rounded-[10px] top-[203px] w-[56.903px]" />
      <L1 />
      <L />
      <Ground />
    </div>
...
export default function IndoorNavigation() {
  return (
    <div className="bg-white relative size-full" data-name="indoor navigation">
      ...
      <div className="absolute bg-white h-[96px] left-0 top-[48px] w-[390px]" data-name="Rectangle" />
      <Frame1 />
      <div className="absolute h-[573px] left-[-28px] top-[244px] w-[708px]" data-name="Image 24-11-2025 at 09.59 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage24112025At09591} />
      </div>
      <ZoomControls />
      <div className="absolute bg-[#f2f6fc] h-[65px] left-0 top-[121px] w-[393px]" data-name="Rectangle" />
      <Group1 />
      <Group2 />
      <Floor />
      <div className="absolute h-[81.35px] left-[calc(50%+8.89px)] top-[713.69px] w-[115.859px]">
        <div className="absolute inset-[-4.92%_-3.45%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 124 90">
            <path d={svgPaths.p12fa4000} id="Vector 12" stroke="var(--stroke-0, #0088FF)" strokeLinecap="round" strokeWidth="8" />
          </svg>
        </div>
      </div>
    </div>
